...
如果 Rust 语法本身影响阅读，可以配合旁边的《[06 补充｜Agent 核心循环涉及的 Rust 源码阅读知识](06-Agent核心循环-Rust源码阅读知识.md)》一起看。

如果希望有人带着一步步读，可以直接看《[06 实战｜Agent 核心循环源码阅读手把手](06-Agent核心循环-源码阅读手把手.md)》。
